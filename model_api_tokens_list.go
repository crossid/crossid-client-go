...
// ApiTokensList struct for ApiTokensList
...
func (o ApiTokensList) MarshalJSON() ([]byte, error) {
...
type NullableApiTokensList struct {
	value *ApiTokensList
	isSet bool
}

func (v NullableApiTokensList) Get() *ApiTokensList {
	return v.value
}

func (v *NullableApiTokensList) Set(val *ApiTokensList) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTokensList) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTokensList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTokensList(val *ApiTokensList) *NullableApiTokensList {
	return &NullableApiTokensList{value: val, isSet: true}
}

func (v NullableApiTokensList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTokensList) UnmarshalJSON(src []byte) error {
	v.isSet = true
