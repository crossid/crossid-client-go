...
// PatchesList struct for PatchesList
...
func (o PatchesList) MarshalJSON() ([]byte, error) {
...
type NullablePatchesList struct {
	value *PatchesList
	isSet bool
}

func (v NullablePatchesList) Get() *PatchesList {
	return v.value
}

func (v *NullablePatchesList) Set(val *PatchesList) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchesList) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchesList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchesList(val *PatchesList) *NullablePatchesList {
	return &NullablePatchesList{value: val, isSet: true}
}

func (v NullablePatchesList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchesList) UnmarshalJSON(src []byte) error {
	v.isSet = true
