...
// VerificationFlowMethodConfigFields struct for VerificationFlowMethodConfigFields
type VerificationFlowMethodConfigFields struct {
...
func NewVerificationFlowMethodConfigFields() *VerificationFlowMethodConfigFields {
	this := VerificationFlowMethodConfigFields{}
	return &this
}
...
func (o VerificationFlowMethodConfigFields) MarshalJSON() ([]byte, error) {
...
type NullableVerificationFlowMethodConfigFields struct {
	value *VerificationFlowMethodConfigFields
	isSet bool
}

func (v NullableVerificationFlowMethodConfigFields) Get() *VerificationFlowMethodConfigFields {
	return v.value
}

func (v *NullableVerificationFlowMethodConfigFields) Set(val *VerificationFlowMethodConfigFields) {
	v.value = val
	v.isSet = true
}

func (v NullableVerificationFlowMethodConfigFields) IsSet() bool {
	return v.isSet
}

func (v *NullableVerificationFlowMethodConfigFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVerificationFlowMethodConfigFields(val *VerificationFlowMethodConfigFields) *NullableVerificationFlowMethodConfigFields {
	return &NullableVerificationFlowMethodConfigFields{value: val, isSet: true}
}

func (v NullableVerificationFlowMethodConfigFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVerificationFlowMethodConfigFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
