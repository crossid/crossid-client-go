...
func (r ApiGetLoginFlowRequest) Execute() (CrossFlow, *_nethttp.Response, error) {
 ...
 */
func (a *LoginApiService) GetLoginFlow(ctx _context.Context, id string) ApiGetLoginFlowRequest {
	return ApiGetLoginFlowRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 * @return CrossFlow
 */
func (a *LoginApiService) GetLoginFlowExecute(r ApiGetLoginFlowRequest) (CrossFlow, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/auth/flows/login/{id}"
